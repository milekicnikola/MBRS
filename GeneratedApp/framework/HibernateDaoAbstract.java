...
public abstract class HibernateDaoAbstract<T extends EntityAbstract> implements DaoGeneric<T> {
	...
	public HibernateDaoAbstract() {
		this.persistentClass = (Class<T>) ((ParameterizedType) getClass().getGenericSuperclass())
				.getActualTypeArguments()[0];
	}

	protected HibernateDaoAbstract(Class<T> persistentClass) {
		super();
