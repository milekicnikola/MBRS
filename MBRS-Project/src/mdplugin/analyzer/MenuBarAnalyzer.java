				...
				if (ownedElement instanceof Class) {
					...
					if (StereotypesHelper.getAppliedStereotypeByString(cl, "StandardForm") != null) {
						...
						fmClass.addImportedPackage(
								"ejb" + getImportedPackage("", pack, AnalyzerTypeEnum.MENU) + "." + pack.getName());
						fmClass.addImportedPackage(
								"dao" + getImportedPackage("", pack, AnalyzerTypeEnum.MENU) + "." + pack.getName());
						fmClass.addImportedPackage("standardForm" + getImportedPackage("", pack, AnalyzerTypeEnum.MENU)
								+ "." + pack.getName());
