			...
			for (Iterator<Element> it = pack.getOwnedElement().iterator(); it.hasNext();) {
				...
				if (ownedElement instanceof Class) {
					...
					if (StereotypesHelper.getAppliedStereotypeByString(cl, "StandardForm") != null) {
						...
						fmClass.addImportedPackage("ejb" + getImportedPackage("", pack, AnalyzerTypeEnum.HIBERNATE)
								+ "." + pack.getName());
						fmClass.addImportedPackage("dao" + getImportedPackage("", pack, AnalyzerTypeEnum.HIBERNATE)
								+ "." + pack.getName());
						fmClass.addImportedPackage("standardForm"
								+ getImportedPackage("", pack, AnalyzerTypeEnum.HIBERNATE) + "." + pack.getName());
